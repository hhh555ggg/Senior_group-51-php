...
if (isset($_POST['username'])) {
	...
	if (!empty($username)) {
		if (strlen($username) >= 6) {
			if (preg_match('/senior$/', $username)) {
				...
				$msg[] = 'username should end with senior';
			}
		} else {
	...
	if ($flag == 2) 
	{
		...
		$stat="insert into users(username,email,password) values ('$username','$email','$password')";
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
						<h3 class="mb-4 text-center">Have an account?<a href="login.php"> Login In </a></h3>
