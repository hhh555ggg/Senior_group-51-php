...
<body cz-shortcut-listen="true">
    ...
    <header class="blog-header py-3">
      <div class="row flex-nowrap justify-content-between align-items-center">
        <div class="col-4 pt-1">
          <a class="link-secondary" href="#"><?= $_GET['username'] ?></a>
        </div>
  ...
  <main class="container">
    ...
    <div class="row mb-2">
      ...
      ?>
        <div class="col-md-6" style="background-color: <?= $user['color'] ?>;">
          <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
            <div class="col p-4 d-flex flex-column position-static">
              <strong class="d-inline-block mb-2 text-primary"><?= $user['name'] ?></strong>
              <h3 class="mb-0"><?= $user['age'] ?></h3>
              <div class="mb-1 text-muted"><?= $user['address'] ?></div>
